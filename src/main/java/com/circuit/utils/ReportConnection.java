...
public class ReportConnection {
    ...
    public static final String BUS_CLEARANCE_REPORT = "busclearance_report.jasper";
    public static final String WORK_CLEARANCE_REPORT = "work_clearance.jasper";
    public static final String PED_CLEARANCE_REPORT = "ped_clearance.jasper";
